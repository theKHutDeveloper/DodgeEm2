...
class LevelScreen3 extends Screen {
    private OrthoCamera camera;
    private ArrayList<Button> buttons = new ArrayList<Button>();
    private Stage stage;


    LevelScreen3(int direction){
    ...
    public void create() {
                ...
                stage.addAction(Actions.sequence(Actions.parallel(Actions.fadeOut(.5f),
                        ...
                        Actions.run(
                                new Runnable() {
                                    @Override
                                    public void run() {
                                        ScreenManager.setScreen(new LevelScreen4(1));
                                    }
                                })));
            }
        });
        ...
        marker_off.setPosition(102 , 112 );
