...
class LevelScreen4 extends Screen{
    ...
    public void create() {
                ...
                stage.addAction(Actions.sequence(Actions.parallel(Actions.fadeOut(.5f),
                        ...
                        Actions.run(
                                new Runnable() {
                                    @Override
                                    public void run() {
                                        ScreenManager.setScreen(new LevelScreen5(1));
                                    }
                                })));
            }
        });
        ...
        marker_off2.setPosition(102 , 112 );
